...
if __name__ == "__main__":
    ...
    for date_obj, trade_date in all_dates:
        ...
        query = f"创业板,非st,{trade_date}竞价涨幅,{trade_date}竞价匹配价,竞价成交量,{trade_date}05:25分时换手率,{trade_date}05:25分时量比,{trade_date}竞价量，竞价金额, {trade_date}竞价未匹配量, {trade_date}竞价未匹配金额, 竞价主力资金流向,{trade_date}流通市值，竞价dde大单净额, 竞价大单净额, 竞价中单净额, 竞价小单净额"
